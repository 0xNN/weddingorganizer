  <head>
	...
	<div class="row">
                <div class="col-md-6 col-sm-12">
				    <div class="card">
				        <div class="mySlides fade">
							...
							<img src="<?php echo base_url(); ?>assets/images/fb18.jpg" style="width:70%">
							<div class="text">TENDA</div>
						</div>
						<div class="mySlides fade">
							<div class="numbertext">2 / 4</div>
							<img src="<?php echo base_url(); ?>assets/images/fb20.jpg" style="width:70%">
							<div class="text">TENDA</div>
						</div>
						<div class="mySlides fade">
							<div class="numbertext">3 / 4</div>
							<img src="<?php echo base_url(); ?>assets/images/fb19.jpg" style="width:70%">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="card">
                    <p align="center" style="color:white"><b>Paket B = Rp. 8.000.000.- </p></b>
