        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal" action="<?= base_url() . 'pelanggan/konfirmasi/store' ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text" name="nama_bank" value="" class="form-control" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text" name="no_rek" value="" class="form-control" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text" name="pemilik" value="" class="form-control" required>
