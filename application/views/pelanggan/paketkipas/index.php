        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <p class="text-success font-weight-bold">
              RP. <?= number_format($paketkipas[0]->harga_paket) ?>
            </p>
          </div>
        </div>
      </div>
