  <head>
   ...
   <style>
	...
	<div class="row">
                <div class="col-md-6 col-sm-12">
				    <div class="card">
				        <div class="mySlides fade">
							...
							<div class="text">KIPAS ANGIN BLOWER</div>
						</div>
						<div class="mySlides fade">
							<div class="numbertext">2 / 2</div>
							<img src="<?php echo base_url(); ?>assets/images/fb34.jpg" style="width:70%">
							<div class="text">KIPAS ANGIN BLOWER</div>
						</div>
						<br>
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="card">
                    <p align="center" style="color:white"><b>Paket Kipas Angin = Rp. 800.000.- </p></b>
                    <ol align="left" style="color:white">
                    	<li>Kipas Angin Blower</li>
                    </ol>
