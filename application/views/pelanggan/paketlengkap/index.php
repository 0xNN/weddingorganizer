      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <p>
              <?= $paketlengkap[0]->keterangan_paket ?>
            </p>
            <p class="text-uppercase text-lg-left font-weight-bold">
              LIST PAKET
            ...
            <p class="text-success font-weight-bold">
              RP. <?= number_format($paketlengkap[0]->harga_paket) ?>
            </p>
          </div>
        </div>
      </div>
