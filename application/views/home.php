            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <h4>INFORMASI KONTAK</h4>
                        <p align="left"><i class="fa fa-envelope"> Email   : </i> <?= $profil->email ?> </p>
                        <p align="left"><i class="fa fa-phone"> Telp   : </i> (<?= $profil->no_telp ?>) </p>
                        <p align="left"><i class="fa fa-map-marker"> Alamat : </i> <?= $profil->alamat ?> </p>
                </div>
                <div class="col-md-4">
                    <h4>METODE PEMBAYARAN</h4>
                    <img src="<?php echo base_url(); ?>assets/images/bri.png">
                    <p>No Rek: 355701008975500</p>
                </div>
            </div>
        </div>
    </footer>
